...
import { getClientProjectAccessById } from 'apiSdk/client-project-accesses';
...
function ClientProjectAccessViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Client Project Access Detail View
          </Text>
          {hasAccess('client_project_access', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/client-project-accesses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
