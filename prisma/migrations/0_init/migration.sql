...
-- AddForeignKey
ALTER TABLE "client_project_access" ADD CONSTRAINT "client_project_access_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "client_project_access" ADD CONSTRAINT "client_project_access_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
